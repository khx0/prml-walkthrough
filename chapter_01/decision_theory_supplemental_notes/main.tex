...
Figure 1.27 in chapter 1 depicts a similar example as figure 1.24 and 1.46, but in contrast to figure 1.24 here he start from a given prior class conditional distribution $p(x \, | C_k)$ (see figure 1.27 left) and not from the full joint probability distribution as we did in figure 1.24.
