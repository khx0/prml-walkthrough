...
# date: 2019-04-10
# file: figure_1.7_assay_C_too_strong_reg.py
...
if __name__ == '__main__':
    ...
    label = r'$\log\lambda = 0$'

    outname = 'figure_1.7_N_%d_PRNG-seed_%d_C_too_strong_reg' %(nTrain, seedValue)
