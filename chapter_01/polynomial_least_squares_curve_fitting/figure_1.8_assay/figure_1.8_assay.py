...
if __name__ == '__main__':
    ...
    # PRML Bishop Chapter 1 Introduction - Curve Fitting - figure 1.8 assay
    ...
    ######################################################################################
    # polynomial least squares curve fitting with quadratic regularization
    # (learning the model)
    ...
    ######################################################################################
    # file i/o
    outname = f'figure_1.8_data_PRNG-seed_{seedValue}.txt'
    ...
    outname = f'prml_ch_01_figure_1.8_PRNG-seed_{seedValue}'
