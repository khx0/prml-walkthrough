...
Z^2 \sim \chi_1^{2}
\end{align}
is distributed according to a $\chi^2$ distribution with one degree of freedom ($\text{d.o.g.} = 1$).

There are several ways to show this result. We will follow an approach which utilizes several properties of the cumulative distribution function (CDF).
